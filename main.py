...
# هنا حددنا إن البوت هيستجيب للأوامر اللي بتبدأ بـ !
...
async def on_message(message):
    ...
    # السطر ده مهم جداً عشان يخلي البوت يقرأ الأوامر زي ping وميتجاهلهاش
    await bot.process_commands(message)

# إضافة أمر البينج
@bot.command()
async def ping(ctx):
    # حساب البينج بالمللي ثانية
    latency = round(bot.latency * 1000)
    await ctx.send(f'هلا !\nالبينج الخاص بالبوت: **{latency}ms**')
